...
const Bottomnav = () => {
  ...
  return (
    <div className="b">
      <div className={`flex ${isMobile ? "absolute" : "hidden"}   bottomnav rounded-t-2xl bottom-0 bg-opacity-30 backdrop-filter backdrop-blur-2xl bg-white dark:bg-feedheader border-t-2 border-fuchsia-100 z-40 w-full`}>
