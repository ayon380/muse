    ...
    return (
        ...
        >
            ...
            <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
                <h1 className="text-3xl font-bold mb-6 text-center text-purple-600">Report User</h1>
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <textarea
                            id="reason"
                            rows="4"
                            className="w-full border h-24 border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-purple-500"
