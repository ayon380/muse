  ...
  return (
    <>
      ...
      >
        ...
        {showComments && (
          <PostComment db={db} setShowComments={setShowComments} userdata={userdata} postdata={postdata} usermetadata={usermetadata} enqueueUserMetadata={enqueueUserMetadata} uid={uid} />
        )}
